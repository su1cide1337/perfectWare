...
void Clan_Tag() {
	...
	if (Settings.GetSetting(Tab_Misc, Misc_Clan_Active)) {
		...
		{
		case 0:
		case 1: SetClanTag("perfectWare.", "perfectWareV1"); break;
		case 2: SetClanTag("PERFECTWARE \r", "perfectWareV1"); break;
			//case 2: SetClanTag("[VALV\xE1\xB4\xB1]", "Valve"); break;

		case 3:
		{
			if (Hacks.CurrentCmd->buttons & IN_ATTACK)
				SetClanTag("Aimbotting", "perfectWareV1");
			else if (Hacks.CurrentCmd->buttons & IN_JUMP)
				SetClanTag("Bouncing", "perfectWareV1");
			else if (Hacks.CurrentCmd->buttons & IN_DUCK)
				SetClanTag("Getting Low", "perfectWareV1");
			else
				SetClanTag("perfectWare.", "perfectWareV1");
		}
		break;
		...
		case 4:
		{
			...
			switch (value) {
			case 0:SetClanTag("                ", "perfectWareV1"); break;
			case 1:SetClanTag("               p", "perfectWareV1"); break;
			case 2:SetClanTag("              pe", "perfectWareV1"); break;
			case 3:SetClanTag("            per", "perfectWareV1"); break;
			case 4:SetClanTag("           perf", "perfectWareV1"); break;
			case 5:SetClanTag("         perfe", "perfectWareV1"); break;
			case 6:SetClanTag("        perfec", "perfectWareV1"); break;
			case 7:SetClanTag("       perfect", "perfectWareV1"); break;
			case 8:SetClanTag("     perfectW", "perfectWareV1"); break;
			case 9:SetClanTag("    perfectWa", "perfectWareV1"); break;
			case 10:SetClanTag("  perfectWar", "perfectWareV1"); break;
			case 11:SetClanTag(" perfectWar", "perfectWareV1"); break;
			case 12:SetClanTag("perfectWare ", "perfectWareV1"); break;
			case 13:SetClanTag("erfectWare   ", "perfectWareV1"); break;
			case 14:SetClanTag("rfectWare    ", "perfectWareV1"); break;
			case 15:SetClanTag("fectWare      ", "perfectWareV1"); break;
			case 16:SetClanTag("ectWare       ", "perfectWareV1"); break;
			case 17:SetClanTag("ctWare         ", "perfectWareV1"); break;
			case 18:SetClanTag("tWare          ", "perfectWareV1"); break;
			case 19:SetClanTag("Ware             ", "perfectWareV1"); break;
			case 20:SetClanTag("are               ", "perfectWareV1"); break;
			case 21:SetClanTag("re                ", "perfectWareV1"); break;
			case 22:SetClanTag("e                  ", "perfectWareV1"); break;
			case 23:SetClanTag("                   ", "perfectWareV1"); break;
			}
			counter++;
		}
		break;
		...
		case 5:
		{
			...
			switch (value) {
			case 0:SetClanTag("\r perfectWare.", "perfectWareV1"); break;
			case 1:SetClanTag("perfectWare. \r", "perfectWareV1"); break;
			case 2:SetClanTag("\r perfectWare.", "perfectWareV1"); break;
			case 3:SetClanTag("perfectWare. \r", "perfectWareV1"); break;
			case 4:SetClanTag("\r perfectWare.", "perfectWareV1"); break;
			case 5:SetClanTag("perfectWare. \r", "perfectWareV1"); break;
			case 6:SetClanTag("\r perfectWare.", "perfectWareV1"); break;
			case 7:SetClanTag("perfectWare. \r", "perfectWareV1"); break;
			}
			counter++;
		}
		break;
...
void Spamer() {
	...
	case 1: {
		int value = counter % 3;
		switch (value) {
		case 1: message << " WWW.SU1CIDE.PW | own u :^)"; break;
		case 2: message << " perfectWare > you"; break;
		case 3: message << " WWW.SU1CIDE.PW"; break;
...
void Name_Stealer()
{
	...
	if (Settings.GetBoolSetting(Tab_Misc, Misc_NameStealer))
	{
		...
		{
		case 0:
		case 1: NewName << "SU1CIDE.PW"; break;
		case 2: NewName << "SU1CIDEBOYZ.RU"; break;
...
IMaterial *Draw_Model_Exec_Hacks::Create_Material(bool Ignore, bool Lit, bool Wireframe)
{
	...
	sprintf_s(name, sizeof(name), "#pWare_Chams_%i.vmt", created); ++created;
